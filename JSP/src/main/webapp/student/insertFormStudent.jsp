		...
		<table align="center" border="1" cellpadding="1" cellspacing="0"
			...
			<tr height="40">
				<td width="200" colspan="2" align="center"><input type="button"
					...
					onclick="location.href='displayStudent.jsp';"></td>
			</tr>
		</table>
	</form>
